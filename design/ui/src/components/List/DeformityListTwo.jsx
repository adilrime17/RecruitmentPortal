...
import DeformityListThree from "./DeformityListThree";
...
export default function SelectedListItem(props) {
  ...
  // console.log("Two: ", deformityListArray);
  ...
  return (
    <div className={classes.root}>
      ...
      >
        <DeformityListThree
          deformityList={selectedListItem} handleAddDeformity={props.handleAddDeformity} handleClose={handleClose}
        />
      </Popover>
    </div>
  );
